...
class UnitService:
    ...
    def __init__(self, mqtt_service) -> None:
        ...
        # Init hardware
        self.light_sensor = LightSensorGl5528("lightPercent", config.light_sensor_pin)
        self.soil_moisture_sensor = SoilMoistureSensor("soilMoisturePercent", config.soil_moisture_sensor_pin)
    ...
    async def send_status_to_server(self) -> None:
        ...
        status_dict.update([
            await self.soil_moisture_sensor.read_percent(300),
            await self.light_sensor.read_percent(300),
